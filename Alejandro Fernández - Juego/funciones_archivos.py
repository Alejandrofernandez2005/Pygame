...
def guardar_estadisticas_json(nombre_usuario, puntaje, monedas, vidas, aciertos, errores, tiempos_respuesta, path):
    ...
    try:
        ...
        print(f"Error al guardar estadísticas desde el {path} con el siguiente error: {e}")
...
def convertir_json_a_matriz(path_json: str) -> list:
    ...
    encabezados = ["Nombre de Usuario", "Puntaje", "Vidas Restantes", "Errores (%)", "Tiempo Promedio (s)"]
